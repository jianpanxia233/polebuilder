...
export class PopupWindow {
	constructor(area_div, drag_div, resize_div, container_div, title_div, resize_func = null, showhide_func = null, focus_func = null, needclamp = true, resize_offestX = 0, resize_offestY = 0) {
		this.area_div = typeof (area_div) === 'string' ? document.getElementById(area_div) : area_div
		this.drag_div = typeof (drag_div) === 'string' ? document.getElementById(drag_div) : drag_div
		this.resize_div = typeof (resize_div) === 'string' ? document.getElementById(resize_div) : resize_div
		this.container_div = typeof (container_div) === 'string' ? document.getElementById(container_div) : container_div
		this.title_div = typeof (title_div) === 'string' ? document.getElementById(title_div) : title_div

		...
		<div class="form-container">
			...
			<div class="form-vcontainer sub">
				<div class="form-container left">
					<div class="title-dark left" style="margin-left: 0px;">
						连接的组件的含有并满足属性
					</div>
					<div class="form-container icon">
						<div v-show="!isValid"
				...
				<div class="listview-dark" @click.stop>
					<div class="form-container">
						<div class="form-container">
							<div class="form-container icon leftpadding rightpadding">
								<div class="title-dark" style="text-align: left; margin-bottom: 0px;">属性名</div>
							</div>
							<div class="form-container leftpadding">
								<input class="lineedit-dark"
									style="margin-left: 0px; width: 100%; font-family: consolas;" v-model="PropertyName"
						...
						<div class="form-container">
							<div class="form-container icon leftpadding rightpadding">
								<div class="title-dark"
									style="text-align: left; margin-bottom: 0px; font-family: consolas;">目标值</div>
							</div>
							<div class="form-container leftpadding">
								<input class="lineedit-dark" style="margin-left: 0px; width: 100%;" v-model="Value"
									@input="on_Input_Change()" />
							</div>
						</div>
					</div>
...
<script>
	export default {
		...
		watch: {
			property(newval) {
				this.PropertyName = newval.Name
				this.SelfList = newval.Value
			}
		},
		methods: {
			on_Click() {
			...
			on_Input_Change() {
				if (this.PropertyName === '' || this.Value === '') {
					this.isValid = false
				}
				else {
					this.isValid = true
					this.$emit('change', { Name: this.PropertyName, Value: this.Value })
				}

<template>
	<div id="PW_Setting" style="width: 100%; height: 100%; position: relative;">
		<div class="Layout-Panel" id="PW_Setting_ListPanel">
				...
				<div class="v-box">
					<div class="scroll-container flex" style="padding-right: 0px;">
						...
						<div class="listview-dark">
							<div class="form-vcontainer vbuttonlist">
								<div v-for="(item, index) in ClassList"
									:class="{'button-dark': true, 'contextleft': true, 'selected': item===SelectedClass}"
									@click="SelectedClass = item" :key="item">
						...
						<div class="listview-dark">
							<div class="form-vcontainer vbuttonlist">
								<div :class="{'button-dark': true, 'contextleft': true, 'selected': '关于'===SelectedClass}"
									@click="SelectedClass = '关于'">
									<a class="button-text">关于</a>
								</div>
								<div class="button-dark contextleft">
									<a class="button-text">{{Version}}</a>
								</div>
							</div>
						</div>
						<!-- <div class="filler"></div>
		...
		<div class="Layout-Panel" id="PW_Setting_ItemPanel">
			<div class="container full">
				<div class="v-box">
					<div class="scroll-container flex" v-if="SelectedClass==='主题'">
						<div class="title1-dark">
							主题
						</div>
						<div class="listview-dark">
							<div class="form-container gap">
								<div class="form-container fixedwidth">
									<div class="title-dark" style="margin-bottom: 0px;">主题</div>
								</div>
								<div class="form-vcontainer right gap">
									<div class="form-container right hbuttonlist">
										<div :class="{'button-dark': true, 'selected': Theme === 'light'}"
											@click="set_Light_Theme('light')">
											<a class="button-text">
												sun 亮色主题
											</a>
										</div>
										<div :class="{'button-dark': true, 'selected': Theme === 'dark'}"
											@click="set_Light_Theme('dark')">
											<a class="button-text">
												sun 暗色主题
											</a>
										</div>
										<!-- <div :class="{'button-dark': true, 'selected': Theme === 'highcontrast'}"
											@click="set_Light_Theme('highcontrast')">
											<a class="button-text">
												sun 高对比
											</a>
										</div> -->
						...
						<!-- <div class="listview-dark">
							<div class="form-container gap">
								<div class="form-container fixedwidth">
									<div class="title-dark" style="margin-bottom: 0px;">主题色</div>
								</div>
								<div class="form-vcontainer right">
									<div class="form-container right">
										<color-picker class="colorpicker-dark" style="width: 100px;"
											v-model="ThemeColor" />
									</div>
								</div>
							</div>
						...
						<!-- <div class="listview-dark">
							<div class="form-container">
								<div class="form-container icon leftpadding fixedwidth">
									<div class="title-dark" style="margin-bottom: 0px;">主题色</div>
								</div>
								<div class="form-vcontainer sub right">
									<div class="form-container right">
										<template v-for="color in ColorList">
											<div :class="{'select-dark': true, 'selected': Color===color}"
												@click="set_Light_Theme(true)"
												:style="{'width': '18px', 'background-color': color, 'align-self': 'center'}">
											</div>
										</template>
									</div>
								</div>
					...
					<div class="scroll-container flex" v-if="SelectedClass==='界面'">
						<div class="title1-dark">
							界面
						</div>
						<div class="listview-dark">
							<div class="form-container gap">
								<div class="form-container">
									<div class="title-dark" style="margin-bottom: 0px;">界面布局</div>
								</div>
								<div class="form-vcontainer sub right">
									<div class="form-container right">
										<div class="button-dark" @click="$EventBus.$emit('app_reset_Layout')">
											<a class="button-text">
												重置界面布局
											</a>
										</div>
						...
						<!-- <div class="listview-dark">
							<div class="form-container">
								<div class="form-container">
									<div class="title-dark" style="margin-bottom: 0px;">手册</div>
								</div>
								<div class="form-vcontainer sub right">
									<div class="form-container right">
										<div class="button-dark" @click="$EventBus.$emit('manual_show_hide')">
											<a class="button-text">
												打开/关闭
											</a>
										</div>
						...
						<!-- <div class="listview-dark">
							<div class="form-container">
								<div class="form-container icon leftpadding fixedwidth">
									<div class="title-dark noleftmargin">功能页面</div>
								</div>
								<div class="form-vcontainer gap" style="max-width: 250px;">
									<div class="form-container">
										<div class="title-dark">地图</div>
										<div class="space6px"></div>
										<input class="checkbox1-dark" type="checkbox" />
									</div>
									<div class="form-container">
										<div class="title-dark">编辑器</div>
										<div class="space6px"></div>
										<input class="checkbox1-dark" type="checkbox" />
									</div>
									<div class="form-container">
										<div class="title-dark">呈现</div>
										<div class="space6px"></div>
										<input class="checkbox1-dark" type="checkbox" />
									</div>
									<div class="form-container">
										<div class="title-dark">综合箱</div>
										<div class="space6px"></div>
										<input class="checkbox1-dark" type="checkbox" />
									</div>
									<div class="form-container">
										<div class="title-dark">组件导入</div>
										<div class="space6px"></div>
										<input class="checkbox1-dark" type="checkbox" />
									</div>
								</div>
						...
						<!-- <div class="listview-dark">
							<div class="form-container">
								<div class="form-container icon leftpadding fixedwidth">
									<div class="title-dark" style="margin-bottom: 0px;">布局</div>
								</div>
								<div class="form-container sub right">
									<div class="selectview-dark">
										<div class="form-vcontainer center">
											<div class="form-container icon center leftpadding">
												<svg class="icon-dark extra" viewBox="0 0 97 97"
									...
									<div class="selectview-dark">
										<div class="form-vcontainer center">
											...
											<div class="title-dark">Advance</div>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="scroll-container flex" v-if="SelectedClass==='系统'">
						<div class="title1-dark">
							系统
						</div>
						<div class="listview-dark">
							<div class="form-container">
								<div class="form-container icon leftpadding fixedwidth">
									<div class="title-dark" style="margin-bottom: 0px;">角度单位</div>
								</div>
								<div class="form-vcontainer sub right">
									<div class="form-container right">
										<div class="button-dark left">
											<a class="button-text">角度</a>
										</div>
										<div class="button-dark hcenter">
											<a class="button-text">弧度</a>
										</div>
										<div class="button-dark right">
											<a class="button-text">PI的倍数 rad</a>
										</div>
									</div>
								</div>
							</div>
					...
					<div class="scroll-container flex" v-if="SelectedClass==='关于'">
						<div class="title1-dark" style="font-size: 30px;">
							合杆合箱三维可视化平台
						</div>
						<img src="../../assets/img/splashscreen1.png"
							style="border-radius: var(--ContainerRadius); object-fit: cover; max-height: 187px;" />
						<div class="title1-dark">
							信息
						</div>
...
<script>
	...
	import { change_UITheme, change_UIThemeColor } from '../Utils.js'
	...
	export default {
		...
		watch: {
			...
			ThemeColor(newval) {
				change_UIThemeColor(newval.r, newval.g, newval.b)
			}
		},
		activated() {
			this.SelectedClass = this.Input.menu || '主题'
		...
		methods: {
			set_Light_Theme(theme) {
				change_UITheme(theme)
				this.Theme = theme
			}
		},
		mounted() {
			this.Layout = new Layouter('PW_Setting', ['PW_Setting_ListPanel', 'PW_Setting_ItemPanel'])
			let PreviewPanel = new Panel('PW_Setting_ListPanel', '', null, false, true, 200, 400)
			let ModulePanel = new Panel('PW_Setting_ItemPanel', '', null, true, true, 400, 400)
			this.Layout.layout_tree.split([PreviewPanel, ModulePanel])
			this.Layout.format()
			// this.Layout.layout_tree.set_Visible(false)
			this.Layout.refresh_Layout()
